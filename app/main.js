var mapView = new ol.View({
    center: ol.proj.fromLonLat([ 28.266624, -20.851993]),
    zoom: 8
});
...
const baseLayerElements = document.querySelectorAll('.sidebar ul> input[type=radio]')
...
var IndiaDsTile = new ol.layer.Tile({
    ...
    source: new ol.source.TileWMS({
        url: 'http://localhost:8080/geoserver/DabaneCadastre/wms',
...
const simphathi = new ol.layer.VectorImage({
    source: new ol.source.Vector({
        url: './data/vectors/simphathi.geojson',
...
const umzingwaneGeoJSON = new ol.layer.VectorImage({
    source: new ol.source.Vector({
        url: './data/vectors/Matobo.geojson',
        format: new ol.format.GeoJSON(),
        projection:'EPSG:32735'
    }),
    visible: true,
...
map.addLayer(simphathi)
map.addLayer(umzingwaneGeoJSON);

var overlayGroup = new ol.layer.Group({
    title: 'Overlays',
    // fold: true,
    layers: [simphathi, IndiaStTile]
});

const layerElements = document.querySelectorAll('.sidebar ul > input[type=checkbox]')
  ...
  for(let layerElement of layerElements){
    layerElement.addEventListener('change', function(){
      ...
      verlayGroup.getLayers().forEach(function(element, index, array){
...
featureInfoButton.innerHTML = '<img src="resources/images/info.png" alt="" style="width:20x;height:20px;filter:brightness(0) invert(1);vertical-align:middle"></img>';
...
lengthButton.innerHTML = '<img src="resources/images/line.png" alt="" style="width:17px;height:17px;filter:brightness(0) invert(1);vertical-align:middle"></img>';
...
areaButton.innerHTML = '<img src="resources/images/area.png" alt="" style="width:17px;height:17px;filter:brightness(0) invert(1);vertical-align:middle"></img>';
